  ...
  newProjects: [
    {
      ...
      img: '../public/images/to-do-app/todo-app.jpeg',
    },
    {
      id: '2',
      desc: `This is a React.js app which records all the To Do's you have on your localStorage. You can also remove, search and hide all the To Do's you have.`,
      ...
      img: '../public/images/hangman-game/hangman-game.jpeg',
    },
    {
      id: '3',
      desc: `This is a React.js app which records all the To Do's you have on your localStorage. You can also remove, search and hide all the To Do's you have.`,
      ...
      img: '../public/images/notes-app/notes-app.jpeg',
    },
  ],
  oldProjects: [
    {
      ...
      img: '../public/images/dice-game/dice-game.jpeg',
    },
    {
      id: '1',
      desc: `This is a React.js app which records all the To Do's you have on your localStorage. You can also remove, search and hide all the To Do's you have.`,
      ...
      img: '../public/images/drum-kit/drum-kit.jpeg',
    },
    {
      id: '1',
      desc: `This is a React.js app which records all the To Do's you have on your localStorage. You can also remove, search and hide all the To Do's you have.`,
      ...
      img: '../public/images/simon-game/simon-game.jpeg',
    },
  ],
};
